  ...
  return (
    <div>
      ...
      <div className=" h-[35rem] mt-10">
        <div className="flex max-lg:flex-col   h-fit justify-between bg-white rounded-lg">
          <div className="h-24 flex flex-col justify-between ml-2  ">
            <h6 className="text-2xl text-semibold">List of Cook accounts</h6>
          </div>
        </div>
