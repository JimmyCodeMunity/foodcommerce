import {
    ...
    return (
      <div>
        <div className="h-24  w-full  max-lg:ml-2 ">
          ...
          text-lanternOrange bg-lanternOrange/30">Delivery earnings</h6>
        ...
        <div className="grid grid-cols-3 gap-3 max-lg:grid-cols-1">
          ...
          >
            <CardContent className="text-center">
              ...
              <h6 className=" font-semibold text-xl">452 <span className="text-red-500 text-sm ml-2">-4%</span></h6>
            </CardContent>
          </Card>
          ...
          <div className=" h-[35rem] mt-10">
            <div className="flex max-lg:flex-col   h-fit justify-between rounded-lg">
              ...
              <div className=" justify-evenly flex  h-24 max-lg:w-11/12 ml-2 mb-2">
                <div
                  component="form"
                  className="w-72 my-4 mx-auto  border border-slate-700 rounded"
                  sx={{
                    p: "2px 4px",
                    display: "flex",
                    alignItems: "center",
                ...
                <div
                  component="form"
                  className="w-72 my-4 ml-4  border border-slate-700 rounded"
                  sx={{
                    p: "2px 4px",
                    display: "flex",
                    alignItems: "center",
  ...
  export default FinanceDelivary;
