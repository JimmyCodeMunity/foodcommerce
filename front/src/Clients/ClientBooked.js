...
const ClientBooked = () => {
  ...
  const settings = {
    appendDots: (dots) => (
      <div className=" w-fit border-2 border-lanternOrange rounded h-2 mx-auto">
        {" "}
        {dots}{" "}
      </div>
    ),
    customPaging: function (i) {
      return (
        <div className="h-2 rounded w-8 border-2 border-lanternOrange">
          <div
            className={`h-full ${
      ...
      <div className="flex">
        <div className="relative max-lg:w-full w-2/3 h-fit">
          ...
          <div className="flex w-full mb-4 justify-between mx-auto">
            <Link to={`/client/home/${Id}`} className=" w-1/2 ml-2">
              <h6
            ...
            <div className="border-b-2 border-black w-1/2 mr-4">
              <h6
          ...
          {foods
            ?.filter((item) => {
              return search.toLowerCase() === ""
                ? item
                : item.meal_name.toLowerCase().includes(search);
            })
            ?.map((item, index) => {
                ...
                >
                  <div className="relative h-full mb-4 ">
                    <div className="w-full mx-auto h-full">
                      <Slider {...settings} className="h-full">
                        {item.meals_images?.map((item, index) => {
                          return (
                            <img
                              src={item?.image_url}
                              alt="lantern foods"
                              className=" max-lg:h-64 h-full"
                            />
                          );
                        })}
                      </Slider>
                    ...
                    <Link to={`/client/tocart/${item.id}`}>
                      <div className="absolute w-fit pt-2 px-2 h-10 bg-white/60 top-0 max-lg:left-7 left-10 text-center py-1">
                  ...
                  <div className="flex flex-col  w-full mx-auto h-20 mb-10">
                    ...
                    <div className="flex w-11/12 justify-between mx-auto items-center">
                      ...
                      <div className=" text-slate-600 flex items-center">
                        <h6 className="flex items-center">
                          <div className="max-lg:right-7 right-10 text-center py-1">
                            {isFavorite ? (
                              <Favorite
                                style={{
                                  color: "#FA6F26",
              ...
              >
                <div className="relative">
                  <Link to={`/client/tocart/${item.id}`}>
                    ...
                    <div className="absolute w-fit px-4 h-10 bg-white/60 top-0 max-lg:left-7 left-7 text-center py-1 ">
                      <h6 className="my-auto font-[kalam] font-normal">
                        {item.cook.kitchen_name}
                      </h6>
                    </div>
