...
const PendingAcceptance = () => {
  ...
  return (
    <div className="font-sans   ">
      ...
      <div className="max-lg:w-11/12  w-1/2 mx-auto flex">
        <Link
          to="/client/myorders"
          className="w-1/2 h-10 rounded border-2 border-red-500 text-red-500"
        >
          <button className="w-full h-full rounded  text-red-500">Back</button>
        </Link>
        <Link
          to="/client/myorders"
